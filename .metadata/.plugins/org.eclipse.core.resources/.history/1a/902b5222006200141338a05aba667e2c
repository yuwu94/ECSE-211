...
public class UltrasonicPoller extends Thread {
	...
	/**Ultrasonic Controller takes a sensor port, and initializes the local US
	 * @param port 		The SensorPort which has the ultrasonic sensor attached.
	 */
	public UltrasonicPoller(SensorPort port){
